...
mod test {
    ...
    fn full_round_ser_der_raw_network_message_test() {
        ...
        let tx: Transaction = deserialize(&hex!("")).unwrap();
        let block: Block = deserialize(&include_bytes!("../../tests/data/testnet_block_e88885ec4f05984493b29d490c5d247036822e9603779bcdd1a979852df2a8b6.raw")[..]).unwrap();
        ...
        let cmptblock = deserialize(&hex!("")).unwrap();
        let blocktxn = deserialize(&hex!("")).unwrap();
