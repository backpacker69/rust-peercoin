...
/// # Examples
/// ```
/// # use peercoin::absolute::{LockTime, LockTime::*};
...
impl LockTime {
    ...
    /// # Examples
    /// ```no_run
    /// # use peercoin::absolute::{LockTime, Height, Time};
...
impl Height {
    ...
    /// # Examples
    /// ```rust
    /// use peercoin::locktime::absolute::Height;
    ///
    /// let h: u32 = 741521;
...
impl Time {
    ...
    /// # Examples
    /// ```rust
    /// use peercoin::locktime::absolute::Time;
    ///
