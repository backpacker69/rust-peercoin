...
mod tests {
   ...
   fn psbt_uncompressed_key() {
    ...
    fn serialize_then_deserialize_output() {
        ...
        let mut sk: ExtendedPrivKey = ExtendedPrivKey::new_master(Peercoin, &seed).unwrap();
    ...
    mod bip_vectors {
        ...
        fn invalid_vector_5() {
            hex_psbt!("").unwrap();
        }
        ...
        fn invalid_vector_5_base64() {
            PartiallySignedTransaction::from_str("").unwrap();
        }
        ...
        fn valid_vector_1() {
            ...
            let base16str = "";
        ...
        #[test]
        fn valid_vector_3() {
            let psbt: PartiallySignedTransaction = hex_psbt!("").unwrap();
        ...
        #[test]
        fn valid_vector_4() {
            let psbt: PartiallySignedTransaction = hex_psbt!("").unwrap();
        ...
        fn valid_vector_6() {
            ...
            assert_eq!(
                tx.txid(),
                "7a4c982b021ba4c72306da467364455ef55c66208281191f5e0b1779718dba0f".parse().unwrap(),
            );
